    ...
    public class SeedDatas
    {
        ...
        public class Handler : IRequestHandler<Command, SeedResponse>
        {
            ...
            public async Task<SeedResponse?> Handle(Command req, CancellationToken cancellationToken)
            {
                ...
                var jlId = Guid.NewGuid();
                var jlId1 = Guid.NewGuid();
                var jlId2 = Guid.NewGuid();
                var jlId3 = Guid.NewGuid();
                var jlId4 = Guid.NewGuid();
                var jamaat1 = new Jamaat("Lafiaji", "ABK-LAFIAJI", circuit1.Id, jlId, "0001");
                var jamaat2 = new Jamaat("Camp-Obantoko", "ABK-OBANTOKO", circuit1.Id, jlId1, "0001");
                var jamaat3 = new Jamaat("Oke-Abetu", "ABK-OKE-ABETU", circuit1.Id, jlId2, "0001");
                var jamaat4 = new Jamaat("Omi-Adio", "IBD-OMI-ADIO", circuit2.Id, jlId3, "0001");
                var jamaat5 = new Jamaat("Apata", "IBD-APATA", circuit2.Id, jlId, "0001");
                var jl = new JamaatLedger(jlId, "0001");
                var jl1 = new JamaatLedger(jlId1, "0001");
                var jl2 = new JamaatLedger(jlId2, "0001");
                var jl3 = new JamaatLedger(jlId3, "0001");
                var jl4 = new JamaatLedger(jlId4, "0001");

                jamaat1.SetJamaatLedger(jl); jamaat2.SetJamaatLedger(jl1); jamaat3.SetJamaatLedger(jl2); jamaat4.SetJamaatLedger(jl3); jamaat5.SetJamaatLedger(jl4);
                ...
                member.SetMemberLedger(ml); member1.SetMemberLedger(ml1); member2.SetMemberLedger(ml2); member3.SetMemberLedger(ml3); member4.SetMemberLedger(ml4);
                ...
                { 
                   ...
                   /* await _jaRepo.AddJamaatLedgerAsync(jl);
                    await _jaRepo.AddJamaatLedgerAsync(jl1);
                    await _jaRepo.AddJamaatLedgerAsync(jl2);
                    await _jaRepo.AddJamaatLedgerAsync(jl3);
                    await _jaRepo.AddJamaatLedgerAsync(jl4);*/
                    ...
                    /*await _memRepo.AddMemberLedgerAsync(ml);
                    await _memRepo.AddMemberLedgerAsync(ml1);
                    await _memRepo.AddMemberLedgerAsync(ml2);
                    await _memRepo.AddMemberLedgerAsync(ml3);
                    await _memRepo.AddMemberLedgerAsync(ml4);*/
